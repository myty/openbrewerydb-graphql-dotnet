...
const _useNearbyBreweriesQuery = (latitude: number, longitude: number) => {
    const { data, loading, error, fetchMore } = useNearbyBreweriesQuery({
        variables: {
            latitude,
            longitude,
        },
...
export const Services = {
    ...
    useNearbyBreweriesQuery: _useNearbyBreweriesQuery,
};
